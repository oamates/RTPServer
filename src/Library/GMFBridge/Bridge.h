...
//
class BridgeController : public CUnknown, public BaseIDispatch<IGMFBridgeController3, &__uuidof(IGMFBridgeController2)>
{
public:
...
private:
    ...
    SmartPtr<BridgeEvents> m_pContainer;
    HWND m_hwndNotify;
